        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h2 class="page-title">Performa</h2>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <br>
                        <table id="scroll-horizontal-datatable" class="table table-striped w-100 nowrap">
                            ...
                            <tbody>
                                <?php $i = 1;
                                foreach ($performa as $k) { ?>
                                    <tr>
                                        <td><?php echo $i; ?></td>
                                        <td><?php echo date('d F Y', strtotime($k['date_start'])); ?></td>
                                        <td><?php echo date('d F Y', strtotime($k['date_end'])); ?></td>
                                        <td><?php echo $k['upload_file']; ?></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="standard-modalLabel">Tambah Performa</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <form action="<?php echo base_url('performa/upload_excel_shopee') ?>" method="post" role="form" enctype="multipart/form-data">
                        <div class="mb-1">
                            <div class="mb-0 position-relative" id="datepicker">
                                <label class="form-label">Date Start</label>
                                <input type="text" name="date_start" class="form-control" data-provide="datepicker" data-date-autoclose="true" data-date-today-highlight="true" value="<?php echo date('m/d/Y'); ?>" data-date-container="#datepicker">
                            </div>
                        </div>
                        <div class="mb-1">
                            <div class="mb-0 position-relative" id="datepicker">
                                <label class="form-label">Date End</label>
                                <input type="text" name="date_end" class="form-control" data-provide="datepicker" data-date-autoclose="true" data-date-today-highlight="true" value="<?php echo date('m/d/Y'); ?>" data-date-container="#datepicker">
                            </div>
                        </div>
                        <div class="mb-1">
                            <label for="simpleinput" class="form-label">Upload File</label>
